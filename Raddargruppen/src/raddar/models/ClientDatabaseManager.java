...
public class ClientDatabaseManager extends Observable {
	...
	// TEST KOD ANV�NDS F�R ATT TESTA KONTAKTLISTAN
	/*
	...
	// TEST KOD F�R MAP
	//addRow(new Fire(new GeoPoint(58395730, 15573080), "H�r brinner det!", SituationPriority.HIGH));
	...
	/**
	 * Returnerar en ArrayList<String> med anv�ndare och l�senord fr�n chachedUsers databasen
	 * @param userName anv�ndarnamnet som ska returneras
	 * @return
	 */
	...
	public ArrayList getAllRowsAsArrays(String table) {
		// TODO g�r s� denna funktion fungerar med alla databastabeller
		// TODO kom inte p� n�got bra s�tt f�r att f� det att fungera i det
		// generella fallet.
